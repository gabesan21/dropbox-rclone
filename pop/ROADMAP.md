...
|---|-------|----------------------|--------|
| 1 | [[pop/roadmap/1-nucleo-backup\|Núcleo: instalação, configuração e motor de backup]] | Script de instalação, configuração rclone/Dropbox, arquivos .env/JSON e motor de agendamento em Go. | pendente |
