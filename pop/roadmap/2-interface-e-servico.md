...
|------|----------------------|--------|
| `2.1.1-crud-tui-backups` | Subcomando `manage` no binário: lista entradas, adiciona/edita via formulário huh validado, remove com confirmação, persiste no JSON. · size: L | não iniciada |
