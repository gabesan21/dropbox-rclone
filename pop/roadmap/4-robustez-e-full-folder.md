...
| Task | Descrição (≤1 linha) | Status |
|------|----------------------|--------|
| `4.2.1-tipo-full-folder` | Novo tipo full-folder: copia o folder como pasta datada (`<base>-<AAAAMMDD-HHMMSS>/`), aplica max_backups excluindo a mais antiga; validação, TUI, restore e README acompanham. · size: M | não iniciada |
